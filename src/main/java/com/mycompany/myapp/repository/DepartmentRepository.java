...
public interface DepartmentRepository extends JpaRepository<Department, Long> {
    ...
    @Query(
        value = "select department from Department department left join fetch department.facility",
    ...
    @Query("select department from Department department left join fetch department.facility")
    List<Department> findAllWithToOneRelationships();

    @Query("select department from Department department left join fetch department.facility where department.id =:id")

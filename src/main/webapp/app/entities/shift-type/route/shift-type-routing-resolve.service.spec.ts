...
import shiftTypeResolve from './shift-type-routing-resolve.service';

describe('ShiftType routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: ShiftTypeService;
  let resultShiftType: IShiftType | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IShiftType returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        shiftTypeResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultShiftType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IShiftType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };

...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().key(DEFAULT_KEY).description(DEFAULT_DESCRIPTION);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().key(UPDATED_KEY).description(UPDATED_DESCRIPTION);
        return task;
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.key(UPDATED_KEY).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.key(UPDATED_KEY).description(UPDATED_DESCRIPTION);

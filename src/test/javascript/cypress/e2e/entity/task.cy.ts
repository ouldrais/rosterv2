...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="key"]`).type('32243');
      cy.get(`[data-cy="key"]`).should('have.value', '32243');

      cy.get(`[data-cy="description"]`).type('uh-huh wiry overturn');
      cy.get(`[data-cy="description"]`).should('have.value', 'uh-huh wiry overturn');

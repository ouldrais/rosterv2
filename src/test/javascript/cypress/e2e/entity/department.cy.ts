...
describe('Department e2e test', () => {
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="key"]`).type('17534');
      cy.get(`[data-cy="key"]`).should('have.value', '17534');

      cy.get(`[data-cy="team"]`).type('indeed lanai svelte');
      cy.get(`[data-cy="team"]`).should('have.value', 'indeed lanai svelte');
